        ...
        <table className="w-full text-left border-collapse text-xs">
          <thead>
            <tr className="bg-slate-50/90 border-b border-slate-200 text-slate-500 font-extrabold uppercase tracking-wider text-[10px]">
              ...
              <th
                className="py-3 px-3.5 text-left w-[210px] cursor-pointer select-none hover:bg-slate-100 transition group"
              ...
              <th className="py-3 px-3 text-left w-[220px]">Target Role & Experience</th>

              {/* Interactive sortable Score column header */}
              <th
                className="py-3 px-2 text-center w-[95px] cursor-pointer select-none hover:bg-slate-100 transition group"
              ...
              <th className="py-3 px-2 text-center w-[130px]">Recommendation</th>
              <th className="py-3 px-3 text-left w-[230px]">Deliberating AI Panel</th>
              <th className="py-3 px-3 text-left min-w-[260px]">Transcript Quote Evidence</th>
              <th className="py-3 px-3 text-center w-[110px]">Action</th>
            </tr>
          </thead>
                ...
                >
                  ...
                  <td className="py-3.5 px-3 align-top">
                    <div className="flex items-center gap-1 mt-0.5 flex-wrap">
                      {cand.panelUsed.slice(0, 3).map((p) => (
                        <div
                          key={p.id}
                          className={`w-6 h-6 rounded-md bg-gradient-to-tr ${getAvatarGradientClass(
                            p.role
                          )} flex items-center justify-center text-white text-[10px] shadow-2xs`}
                          title={`${p.name} (${p.title})`}
                        >
                          {renderAvatarIcon(p.role, 'w-3 h-3')}
                        </div>
                      ))}
                      {cand.panelUsed.length > 3 && (
